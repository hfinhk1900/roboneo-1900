  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: t('textToImageGenerator.items.avatarforge.title'),
          description: t('textToImageGenerator.items.avatarforge.description'),
          icon: '/text-to-image02.png',
          href: Routes.AISticker,
          external: false,
        },
        {
          title: t('textToImageGenerator.items.postercraft.title'),
          description: t('textToImageGenerator.items.postercraft.description'),
          icon: '/text-to-image03.png',
          href: Routes.AIPoster,
          external: false,
        },
        {
          title: t('textToImageGenerator.items.scenedreamer.title'),
          description: t('textToImageGenerator.items.scenedreamer.description'),
          icon: '/text-to-image04.png',
          href: Routes.AIIllustrator,
          external: false,
        },
      ],
