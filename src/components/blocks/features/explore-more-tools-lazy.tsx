      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 lg:gap-6">
          {[...Array(5)].map((_, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-3xl w-full min-h-[380px] sm:min-h-[420px] md:min-h-[440px] animate-pulse"
            >
              {/* Loading content */}
              ...
              <div className="flex justify-center mt-4 sm:mt-5 md:mt-6 mb-4 sm:mb-5 md:mb-6">
                <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-[166px] md:h-[166px] bg-gray-200 rounded-2xl" />
              </div>
