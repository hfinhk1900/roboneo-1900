...
import { Ghost, ImageUp, Sparkles } from 'lucide-react';
...
const steps: Step[] = [
  {
    ...
    image: '/scream-ai/sai-step1-min.png',
  },
  {
    id: 'preset',
    number: '2',
    ...
    image: '/scream-ai/sai-step2-min.png',
  },
  {
    id: 'generate',
    number: '3',
    ...
    image: '/scream-ai/sai-step3-min.png',
  },
];
    ...
    <section id="steps-showcase" className="px-4 py-16 bg-white">
      <div className="mx-auto max-w-6xl space-y-8 lg:space-y-20">
        <HeaderSection
          title="How it Works"
          titleAs="h2"
          subtitle="From Photo to Horror Scene: The 3-Step Flow"
          subtitleAs="h3"
          subtitleClassName="text-3xl lg:text-4xl font-bold text-foreground"
          description="Upload any portrait and let Scream AI transform it into a suspenseful Ghost Face inspired scene—preserving identity while adding cinematic horror atmosphere."
          descriptionAs="p"
            ...
            <div className="relative w-full max-w-md">
              {currentStep?.image ? (
                <OptimizedImage
                  ...
                  alt={`Scream AI Tutorial Step ${currentStep.number}: ${currentStep.title} - How to create horror scenes`}
                  width={400}
                  height={600}
