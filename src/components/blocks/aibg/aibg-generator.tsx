      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center sm:mx-auto lg:mr-auto mb-12">
          ...
          <p className="mx-auto mt-4 max-w-4xl text-balance text-lg text-muted-foreground">
            Upload any photo and Roboneo's AI will instantly remove the background with precision.
          </p>
        </div>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundImage: color.value === 'transparent'
                            ...
                            : 'none',
                          backgroundSize: color.value === 'transparent' ? '20px 20px' : 'auto',
                          backgroundPosition: color.value === 'transparent' ? '0 0, 0 10px, 10px -10px, -10px 0px' : 'auto'
                        }}
