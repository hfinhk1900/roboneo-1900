    ...
    switch (type) {
      case 'website':
        return {
          ...
          "description": "Roboneo AI - Transform photos into iOS-style stickers and create stunning AI-generated images. Free AI art generator with text-to-image and image-to-sticker features.",
