      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            使用 <CustomHighlightText text="AI 图像生成" inView={true} />{' '}
            创建精美艺术作品
          </p>
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg text-sm font-mono">
          <div className="space-y-2">
            ...
            <div className="text-blue-600">
              import &#123; CustomHighlightText &#125; from
              '@/components/custom/highlight';
            </div>
            <div className="text-blue-600">
              import &#123; HighlightText &#125; from
              '@/components/animate-ui/text/highlight';
            </div>
            <div className="mt-4">// 使用组件</div>
            <div>
              &lt;<span className="text-green-600">CustomHighlightText</span>{' '}
              text="您的文字" inView=&#123;true&#125; /&gt;
            </div>
            <div>
              &lt;<span className="text-green-600">HighlightText</span>{' '}
              text="您的文字" inView=&#123;true&#125; /&gt;
            </div>
          </div>
        </div>
