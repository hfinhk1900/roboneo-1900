...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log(`🗑️ Batch deleting ${ids.length} AI Background history items...`);
    ...
    console.log(`📂 Found ${assetIds.length} assets to delete from ${historyRecords.length} history items`);
    ...
    console.log(`✅ Batch deletion completed: ${foundIds.length} history items deleted`);
