...
export const SCREAM_PRESETS: ScreamPreset[] = [
  {
    ...
    prompt:
      'Create a dreamy late-90s bedroom scene. Show EXACTLY ONE HUMAN: the person from the input image lying on shiny pink satin bedding, holding a large 1990s corded telephone to their ear in a relaxed, thoughtful pose. The room includes late-90s posters and a single bedside lamp as the main light source; softly dim nighttime ambience. Use subtle VHS grain, gentle lens bloom, and a cinematic ~35mm composition with shallow depth of field.\n\nIn the doorway of a dim hallway, place a masked figure inspired by "Ghost Face" ONLY as a distant, barely lit silhouette looking toward the subject (no face details, no second person in the room).\n\nIdentity lock for the subject: preserve the input person exactly — facial geometry/proportions, skin tone, eye color, hairline and hair length, and any facial hair if present. DO NOT change gender presentation, age, body shape, hairstyle length or style; DO NOT add or remove makeup, jewelry, nail polish, long eyelashes, hair extensions, or accessories unless already present in the input. Clothing should stay neutral and similar to the input photo; if uncertain, keep simple everyday clothing without added fashion details. Do not feminize or masculinize the subject. Maintain natural-looking anatomy and hands. No blood, no injuries, no gore, no visible weapons, no violence.',
